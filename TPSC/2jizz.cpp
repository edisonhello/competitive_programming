...
int main(){
    ...
    int ts; cin>>ts; while(ts--){
        ...
        for(char &c:str)c-='0';
        /*for(int i=0;i<3;++i){
            RR[0][i*3]=RR[0][i*3+1]=RR[0][i*3+2]=(i==2?0.4:0.3)*C[i][str[0]];
        }
        */RR[0][0*3]=RR[0][0*3+1]=RR[0][0*3+2]=0.0441;
        RR[0][1*3]=RR[0][1*3+1]=RR[0][1*3+2]=0.0933;
        RR[0][2*3]=RR[0][2*3+1]=RR[0][2*3+2]=0.0726;
        cout<<RR<<endl;
        cout<<RR*TT<<endl;
        cout<<RR*TT*TT<<endl;
    }
