...
int main(){
    int n;cin>>n;
    djs.init(n*2+10);
    int c,a,b;while(cin>>c>>a>>b,c){
        if(c==1){
            if(djs.C(a+n,b)||djs.C(a,b+n))cout<<-1<<endl;
            else djs.U(a,b), djs.U(a+n,b+n);
        }
        else if(c==2){
            if(djs.C(a,b)||djs.C(a+n,b+n))cout<<-1<<endl;
            else djs.U(a,b+n), djs.U(a+n,b);
        }
        else if(c==3){
            if(djs.C(a,b)&&djs.C(a+n,b+n))cout<<1<<endl;
            else cout<<0<<endl;
            ...
            if(djs.C(a,b+n)&&djs.C(a+n,b))cout<<1<<endl;
            else cout<<0<<endl;
        }
    }
}
