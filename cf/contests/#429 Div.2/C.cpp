...
int main(){
    ...
    for(int i=0;i<n;++i)cin>>B[i].val,B[i].i=i;
    sort(A,A+n); reverse(A,A+n);
    sort(B,B+n,[](const meow &a,const meow &b){return a.val<b.val;});
    for(int i=0;i<n;++i)B[i].a=A[i];
    
    sort(B,B+n,[](const meow &a,const meow &b){return a.i<b.i;});
    for(int i=0;i<n;++i)cout<<B[i].a<<" ";
}
