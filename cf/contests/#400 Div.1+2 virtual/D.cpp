...
void solve(){
    for(int i=1;i<=n;++i){
        if(situ[i]){
            G[ctb[i][0]].push_back({ctb[i][1],0});
            G[ctb[i][1]].push_back({ctb[i][0],0});
            // cout<<"con 0 edg bet "<<ctb[i][0]<<" , "<<ctb[i][1]<<endl;
        } else {
            G[ctb[i][0]].push_back({ctb[i][1],1});
            G[ctb[i][1]].push_back({ctb[i][0],1});
            // cout<<"con 1 edg bet "<<ctb[i][0]<<" , "<<ctb[i][1]<<endl;
        }
    }
    for(int i=1;i<=m;++i){
        if(!clr[i]){
