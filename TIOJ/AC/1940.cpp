...
int main(){
    ...
    if(k==1)pit(n),el;
        ...
        //     for(int j=1;j<=i/2;++j)mex[i].insert(nim[i-j]);
        //     for(int jj=0;;++jj){
        //         if(mex[i].find(jj)==mex[i].end()){
        //             nim[i]=jj;
        //             mex[i].clear();
        //             break;
        //         }
        ...
        // }
        //
        // for(int i=0;i<65;++i)cout<<i%10<<" ";el;
        // for(int i=0;i<65;i++)cout<<nim[i]<<" ";el;
        // for(int i=0;i<65;i++)cout<<getK2(i)<<" ";el;
    }
}
