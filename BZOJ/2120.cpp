...
int main(){
    ...
    int blk=(int)(ceil(pow(n,2.0/3)));
    for(int i=0,chs=0;i<m;++i){
        char c; int l,r; cin>>c>>l>>r;
        if(c=='Q')q[i]={l,r,i,l/blk,r/blk};
        else q[i]={1,l,l,i,l/blk,l/blk,r};
    }
    sort(q,q+m);
    for(int i=0,l=0,r=0,t=0;i<m;++i){
        while(t<q[i].i)movetime()
    }
}
