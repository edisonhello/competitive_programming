...
int main(){
    ...
    if(c==0 && d!=0)return cout<<"Ron"<<endl,0;
	if(a==0 && b!=0 && d!=0)return cout<<"Ron"<<endl,0;
    if(b==0 || d==0 || f==0)return cout<<"Hermione"<<endl,0;
    if(a==0 || e==0)return cout<<"Ron"<<endl,0;
    if(b/a*d/c*f/e>1)return cout<<"Ron"<<endl,0;
    cout<<"Hermione"<<endl;
}
