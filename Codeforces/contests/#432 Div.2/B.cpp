...
int main(){
    ...
    if((x2-x1)==0 && (x3-x2)==0)return cout<<"No"<<endl,0;
    if(abs(x2-x1)>eps && abs(x3-x2)>eps && abs((y2-y1)*(x3-x2)-(y3-y2)*(x2-x1))<eps)return cout<<"No"<<endl,0;
    if(abs(dist(x1,y1,x2,y2)-dist(x2,y2,x3,y3))<eps)return cout<<"Yes"<<endl,0;
    cout<<"No"<<endl;
}
// 30056383 06:07 WA 5
// 30057707 14:52 WA 3
